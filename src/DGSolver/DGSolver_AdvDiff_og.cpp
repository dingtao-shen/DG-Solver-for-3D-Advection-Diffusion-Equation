                                            ...
                                            std::vector<int>& comp_odr)
    {
        ...
        for(int l = 0; l < CC.N_MESH_CELL; l++){
            ...
            for(int il = 0; il < 4; il++){
                ...
                //     }
                //     for(int i = 0; i < 3; i++){
                //         Coeff = Coeff.array() - K * 0.5 * (f + abs(f)) * StiffFaceMat[CellID][il][i].array() * Cells[CellID]->getOutwardNormVec()[il](i);
                //     }
                // }
        ...
        for(int l = 0; l < CC.N_MESH_CELL; l++){
            ...
            for(int il = 0; il < 4; il++){
                ...
                if(BCTAG == 0){
                    ...
                    for(int d = 0; d < 3; d++){
                        A_src.noalias() += K * 0.5 * (f - abs(f)) * StiffFluxMat[CellID][il][d] * Cells[CellID]->getOutwardNormVec()[il](d) * SolutionPrev[NBR];
                    }
                }
                ...
                // else if(CC.BOUNDARY_COND[BCTAG].first == 2){
                // }
                // else if(CC.BOUNDARY_COND[BCTAG].first == 3){
                // }
                // else if(CC.BOUNDARY_COND[BCTAG].first == 4){
                // }
            }
